const weddingDate = new Date('2026-10-31T17:58:00+08:00')
// 需要真实收集宾客名单时，只需粘贴第三方表单的公开填写链接；留空则保持本地演示模式。
const RSVP_FORM_URL = 'https://my.feishu.cn/share/base/form/shrcnNYdwA95Cl1wPPvxh4s4k7d'
...
if (publicRsvpUrl) {
  ...
  function updateAccommodation() {
    ...
    if (needed) { rsvpForm.elements.checkInAt.value ||= '2026-10-30T14:00'; rsvpForm.elements.checkOutAt.value ||= '2026-10-31T12:00' }
  }
